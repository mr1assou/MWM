    ...
    <>
      ...
      >
        <div className="container">
          <div className="relative -mx-4 flex items-center justify-between h-24">
            {/* header */}
                    ...
                    {menuData.map((menuItem, index) => (
                      <li key={index} className="group relative">
                        {!menuItem.submenu ? (
                          <Link
                            href={menuItem.path}
                            className={`flex py-2 text-base xs:text-sm xl:text-base lg:mr-0 lg:inline-flex lg:px-0 lg:py-6 ${usePathName === menuItem.path
