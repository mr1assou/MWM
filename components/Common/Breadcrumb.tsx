...
const Breadcrumb = ({
  ...
  const sectionRef = useRef(null); // Create a ref to target the breadcrumb section
  ...
  return (
    <section ref={sectionRef} className="relative z-10 overflow-hidden pt-28 lg:pt-[150px]">
