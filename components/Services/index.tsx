  ...
  return (
    ...
    >
      <div className="container">
        <SectionTitle
          title="Our Services"
          paragraph="As a website development company, we offer professional web apps and development services across the United States to help grow your business."
          center
        />
